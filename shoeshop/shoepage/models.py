...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("shoepage:category", kwargs={
            'slug': self.slug
        })
...
class Item(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("shoepage:product", kwargs={
            'slug': self.slug
        })

    def get_add_to_cart_url(self):
        return reverse("shoepage:add-to-cart", kwargs={
            'slug': self.slug
        })

    def get_remove_from_cart_url(self):
        return reverse("shoepage:remove-from-cart", kwargs={
            'slug': self.slug
        })
...
class Payment(models.Model):
    ...
    def __str__(self):
        if self.user:
            ...
            return f"Anonymous User - ${self.amount}"
